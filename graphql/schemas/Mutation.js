const Mutation = `
  type Mutation {
    ...
    createEvent(ItineraryId: ID!, eventType: String, startDay: Int!, startTime: Int, endTime: Int, loadSequence: Int!, notes: String, cost: Int, currency: String, bookingService: String, bookingConfirmation: String, locationVerified: Boolean, googlePlaceData: googlePlaceData, LocationId: ID)

    updateEvent(id: ID!, eventType: String, startDay: Int!, startTime: Int, endTime: Int, loadSequence: Int!, notes: String, cost: Int, currency: String, bookingService: String, bookingConfirmation: String, locationVerified: Boolean, googlePlaceData: googlePlaceData, LocationId: ID)
